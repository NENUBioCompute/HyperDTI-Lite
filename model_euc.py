...
#         #欧式对比
#         self.drug_reduce1 = nn.Linear(1711, 1024)
#         self.drug_reduce2 = nn.Linear(1024, 512)
#         self.drug_reduce3 = nn.Linear(512, self.hyperbolic_dim)
#
#         self.target_reduce1 = nn.Linear(1711, 1024)
#         self.target_reduce2 = nn.Linear(1024, 512)
#         self.target_reduce3 = nn.Linear(512, self.hyperbolic_dim)
#
#         # self.drug_att = HyperbolicSelfAttention(self.hyperbolic_dim, self.curvature)
#         # self.target_att = HyperbolicSelfAttention(self.hyperbolic_dim, self.curvature)
#         self.hyper_cross_att = EuclideanCrossAttention(self.hyperbolic_dim)
#
#         self.hyper_mlp1 = nn.Linear(self.hyperbolic_dim, 64)
#         self.hyper_mlp2 = nn.Linear(64, 32)
#         self.hyper_mlp3 = nn.Linear(32, 2)
#
...
#         reduce_drug_feature = self.drug_reduce1(drug_feature)
#         reduce_drug_feature = self.tanh(reduce_drug_feature)
...
#
#         reduce_target_feature = self.target_reduce1(target_feature)
#         reduce_target_feature = self.tanh(reduce_target_feature)
...
#         # head1 = head_oringal+head_att1
#         # tail1 = tail_oringal+tail_att1
#
...
#         # mid_result = self.poincare_ball.mobius_add(head1, tail1)
#         mid_result = 0.27 * head_oringal+ 0.73 * tail_oringal
#
#         reduce_result1 =self.hyper_mlp1(mid_result)
#         act_reduce_result1 = self.tanh(reduce_result1)
#         reduce_result2 = self.hyper_mlp2(act_reduce_result1)
#         act_reduce_result2 = self.tanh(reduce_result2)
